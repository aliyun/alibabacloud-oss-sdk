...
Alibabacloud_OSS::Client::Client(const shared_ptr<Config> &config) {
  ...
  if (Darabonba_Util::Client::isUnset(config->isEnableMD5)) {
    config->isEnableMD5 = make_shared<bool>(false);
  }
  if (Darabonba_Util::Client::isUnset(config->isEnableCrc)) {
  ...
  shared_ptr<map<string, boost::any>> runtime_ =
      make_shared<map<string, boost::any>>(map<string, boost::any>(
          {{"timeouted", boost::any("retry")},
           ...
           {"localAddr", boost::any(Darabonba_Util::Client::defaultString(
           ...
           {"socks5Proxy", boost::any(Darabonba_Util::Client::defaultString(
                               runtime->socks5Proxy, _socks5Proxy))},
           {"socks5NetWork", boost::any(Darabonba_Util::Client::defaultString(
...
DeleteMultipleObjectsResponse Alibabacloud_OSS::Client::deleteMultipleObjects(
  ...
  while (Darabonba::Core::allowRetry(
    ...
    try {
      ...
      request_->body = Darabonba::Converter::toStream(*reqBody);
      if (!Darabonba_Util::Client::isUnset(request->header) &&
