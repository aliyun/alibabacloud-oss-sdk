...
2. 使用 Visual Studio 进行编译:
  ...
  * 打开 [CMake](https://cmake.org/download/) 软件, 然后进行以下操作
    * 选择 `Browse Source` 为 `源代码目录(alibabacloud_oss)`
...
[提交 Issue](https://github.com/alibabacloud-sdk-cpp/oss/issues/new/choose)，不符合指南的问题可能会立即关闭。
