...
using static AlibabaCloud.OSS.Models.PutBucketAclRequest;
using static AlibabaCloud.OSS.Models.PutObjectRequest;
using static AlibabaCloud.OSS.Models.CopyObjectRequest;
using static AlibabaCloud.OSS.Models.AppendObjectRequest;
using static AlibabaCloud.OSS.Models.PutObjectAclRequest;
using static AlibabaCloud.OSS.Models.PutSymlinkRequest;
using static AlibabaCloud.OSS.Models.InitiateMultipartUploadRequest;
using static AlibabaCloud.OSS.Models.UploadPartRequest;
using static AlibabaCloud.OSS.Models.UploadPartCopyRequest;
using static AlibabaCloud.OSS.Models.ListPartsRequest;
using static AlibabaCloud.OSS.Models.AbortMultipartUploadRequest;
using static AlibabaCloud.OSS.Models.OptionObjectRequest;
...
namespace test
{
    public class ClientTest
    {
        ...
        public void Test_GetBucketReferer()
        {
            ...
            var resp = client.GetBucketReferer(request, runtime);
            Assert.NotNull(resp.RequestId);
            Assert.NotNull(resp.RefererConfiguration);
        }
        ...
        public void Test_PutObject()
        {
            ...
            PutObjectRequest request = new PutObjectRequest
            {
                BucketName = bucketName,
                Header = header,
                Body = new MemoryStream(Encoding.UTF8.GetBytes("value")),
