...
import com.aliyun.oss.baseclient.utils.XmlUtil;
...
public class BaseClient {
    ...
    public BaseClient(Map<String, Object> config) throws ParseException, IOException, CredentialException {
        ...
        this._hostModel = config.get("hostModel") == null ? "" : (String) config.get("hostModel");
        this._signatureVersion = (String) config.get("signatureVersion");
    }
    ...
    protected String _getSignatureV1(TeaRequest teaRequest, String bucketName, String accessKeySecret) throws NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException {
        String resource = "";
    ...
    protected String getSignedStrV1(TeaRequest teaRequest, String canonicalizedResource, String accessKeySecret) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
    ...
    protected String _getSignatureV2(TeaRequest teaRequest, String bucketName, String accessKeySecret,
    ...
    protected String getSignedStrV2(TeaRequest teaRequest, String canonicalizedResource,
    ...
    protected Map<String, Object> _parseXml(String a, Class clazz) throws Exception {
        return XmlUtil.DeserializeXml(a, clazz);
    }
    ...
    protected Map<String, Object> _getErrMessage(String str) throws Exception {
        Map<String, Object> result = XmlUtil.DeserializeXml(str, ErrorResponse.class);
    ...
    protected String _getContentMD5(String body) throws IOException, NoSuchAlgorithmException {
    ...
    protected String _encode(String value, String encodeType) throws UnsupportedEncodingException {
        if (null == encodeType) {
            return value;
        }
    ...
    protected String _toXML(Map<String, Object> map) throws IllegalAccessException {
        return XmlUtil.mapToXml(map);
    }

    protected boolean _empty(Object str) {
        return StringUtils.isEmpty(str);
    }

    protected String _readAsString(TeaResponse teaResponse) throws IOException {
        return teaResponse.getResponseBody();
    }

    protected boolean _notNull(Map<String, Object> map) {
        if (null == map) {
            return false;
        }
        return !map.isEmpty();
    ...
    protected boolean _ifListEmpty(String[] strs) {
        if (strs == null) {
            return true;
        }
    ...
    protected boolean _equal(String str, String str2) {
    ...
    protected InputStream _inject(InputStream is, Map<String, String> ref) throws NoSuchAlgorithmException {
        return new VerifyInputStream(is, ref);
    }

    protected String _listToString(String[] headers, String str) {
        return String.join(str, headers);
    }
}
