...
3. Build and Install C++ SDK
  * Go to the cmake_build directory and open alibabacloud_ossutil.sln with Visual Studio Solutions
  * Select  `Release`
...
[Submit Issue](https://github.com/alibabacloud-sdk-cpp/oss-util/issues/new/choose), Problems that do not meet the guidelines may close immediately.
